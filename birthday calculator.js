...
function calculateBirthday() {
  ...
  if (passBirthday == false) {
    var difference = getDays(birthDay, birthMonth, birthYear);
    console.log(difference);

    var weeks = Math.floor(difference / 7);
    var module = difference % 7;
    var nextAge = currentYear - birthYear;
    console.log(weeks + " " + module + " " + nextAge);
  }
  if (passBirthday == true) {
    birthDate[0]--;
    var difference = getDays(birthDay, birthMonth, birthYear);

    var weeks = Math.floor(difference / 7);
    var module = difference % 7;
    var nextAge = currentYear - birthDate[0];
    console.log(weeks + " " + module + " " + nextAge);
  }
